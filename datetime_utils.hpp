   ...
   {
      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format00 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format01 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format02 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format03 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format04 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format05 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format06 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format07 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format08 - day  \n";
      }

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format09 - day  \n";
      }
...

      {
         ...
         if (dt.day   !=    4) std::cout << "ERROR - date_format11 - day  \n";
      }
...

      {
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format11 - day        \n";
      ...
      {
         std::string data = "04-03-2006T13:27:54.123";
         dt_utils::datetime dt;
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format14 - day        \n";
      ...
      {
         std::string data = "04-03-2006T13:27:54";
         dt_utils::datetime dt;
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format15 - day   \n";
...

      {
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format17 - day   \n";
      ...
      {
         std::string data = "20060304T132754123";
         dt_utils::datetime dt;
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format18 - day   \n";
      ...
      {
         std::string data = "2006-03-04T13:27:54Z";
         dt_utils::datetime dt;
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format19(0) - day   \n";
      ...
      {
         std::string data = "2006-03-04T13:27:54+03:45";
         dt_utils::datetime dt;
         dt_utils::datetime_format19 dt19(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format19(1) - day   \n";
      ...
      {
         std::string data = "2006-03-04T13:27:54-05:37";
         dt_utils::datetime dt;
         dt_utils::datetime_format19 dt19(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format19(2) - day   \n";
      ...
      {
         std::string data = "2006-03-04T13:27Z";
         dt_utils::datetime dt;
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format20(0) - day   \n";
      ...
      {
         std::string data = "2006-03-04T13:27+03:45";
         dt_utils::datetime dt;
         dt_utils::datetime_format20 dt20(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format20(1) - day   \n";
      ...
      {
         std::string data = "2006-03-04T13:27-05:37";
         dt_utils::datetime dt;
         dt_utils::datetime_format20 dt20(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format20(2) - day   \n";
...

      {
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format21(0) - day   \n";
      ...
      {
         std::string data = "Sat, 04 Mar 2006 13:27:54 GMT";
         dt_utils::datetime dt;
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format22(0) - day   \n";
      ...
      {
         std::string data = "Sat, 04 Mar 2006 13:27:54 EST";
         dt_utils::datetime dt;
         dt_utils::datetime_format22 dt22(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format22(1) - day   \n";
      ...
      {
         std::string data = "Sat, 04 Mar 2006 13:27:54 UT";
         dt_utils::datetime dt;
         dt_utils::datetime_format22 dt22(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format22(2) - day   \n";
      ...
      {
         std::string data = "Sat, 04 Mar 2006 13:27:54 M";
         dt_utils::datetime dt;
         dt_utils::datetime_format22 dt22(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format22(3) - day   \n";
      ...
      {
         std::string data = "Sat, 04 Mar 2006 13:27:54 -0234";
         dt_utils::datetime dt;
         dt_utils::datetime_format22 dt22(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format22(4) - day   \n";
      ...
      {
         std::string data = "Sat, 04 Mar 2006 13:27:54 +0325";
         dt_utils::datetime dt;
         dt_utils::datetime_format22 dt22(dt);
         dt.clear();
         ...
         if (dt.day         !=    4) std::cout << "ERROR - datetime_format22(5) - day   \n";
